package br.com.lecom.transportadora.exception;
...
public class TransportadoraExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> hanbleEntityNotFoundException(EntityNotFoundException exception){
    ...
    public ResponseEntity<Object> hanbleEntityExistsException(EntityExistsException exception){
        return buildResponseEntity(
